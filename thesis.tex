...
\usepackage[backend = biber, style = caspervector, utf8, sorting = ecnty, maxnames = 30, minnames = 1]{biblatex}
...
\pkuthssinfo{
	...
	ctitle = {基于深度学习的推荐系统\\技术研究}, etitle = {Deep Learning Based Recommender System},
	cauthor = {吕超},
	eauthor = {Chao Lv},
	...
	ckeywords = {深度学习，推荐系统，特征表示}, ekeywords = {Deep Learning, Recommender System, Feature Representation}
}
